namespace NexusCommunicationSystem.Migrations
{
    ...
    public partial class init : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        CreatedAt = c.DateTime(nullable: false),
                        UpdatedAt = c.DateTime(nullable: false),
                        BillingAmount = c.Int(nullable: false),
        ...
        {
            DropForeignKey("dbo.Contracts", "ServicePackageId", "dbo.ServicePackages");
            ...
            DropForeignKey("dbo.Contracts", "RetailStoreId", "dbo.RetailStores");
            ...
            DropIndex("dbo.Contracts", new[] { "ServicePackageId" });
            DropIndex("dbo.Contracts", new[] { "RetailStoreId" });
