...
namespace NexusCommunicationSystem.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<NexusCommunicationSystem.Models.NexusCommunicationSystemContext>
    {
        ...
        protected override void Seed(NexusCommunicationSystem.Models.NexusCommunicationSystemContext context)
        {
            ...
            listContract.Add(new Contract(OrderStatus.Pending, 0.3, 200,  5, new DateTime(2020, 1, 3)   , 0.1, context.Customers.Where(c => c.Id == 1).Single(), context.Services.Where(s => s.Id == 1).Single(), context.RetailStores.Where(a => a.Id == 1).Single(), context.ServicePackages.Where(sp=>sp.Id==1).Single(),      new DateTime(2020, 1, 3)    ,  new DateTime(2020, 1, 3)      ));
            listContract.Add(new Contract(OrderStatus.Pending, 0.3, 400,  5, new DateTime(2020, 1, 2)   , 0.1, context.Customers.Where(c => c.Id == 2).Single(), context.Services.Where(s => s.Id == 2).Single(), context.RetailStores.Where(a => a.Id == 2).Single(), context.ServicePackages.Where(sp => sp.Id == 1).Single(),  new DateTime(2020, 1, 2)    ,  new DateTime(2020, 1, 2)      ));
            listContract.Add(new Contract(OrderStatus.Pending, 0.3, 500,  5, new DateTime(2020, 1, 1)   , 0.1, context.Customers.Where(c => c.Id == 3).Single(), context.Services.Where(s => s.Id == 3).Single(), context.RetailStores.Where(a => a.Id == 3).Single(), context.ServicePackages.Where(sp => sp.Id == 1).Single(),  new DateTime(2020, 1, 1)    ,  new DateTime(2020, 1, 1)      ));
            listContract.Add(new Contract(OrderStatus.Pending, 0.3, 900,  5, new DateTime(2019, 12, 15) , 0.1, context.Customers.Where(c => c.Id == 3).Single(), context.Services.Where(s => s.Id == 3).Single(), context.RetailStores.Where(a => a.Id == 3).Single(), context.ServicePackages.Where(sp => sp.Id == 1).Single(),  new DateTime(2019, 12, 15)  ,  new DateTime(2019, 12, 15)    ));
            listContract.Add(new Contract(OrderStatus.Pending, 0.3, 400,  5, new DateTime(2019, 10, 15) , 0.1, context.Customers.Where(c => c.Id == 3).Single(), context.Services.Where(s => s.Id == 3).Single(), context.RetailStores.Where(a => a.Id == 3).Single(), context.ServicePackages.Where(sp => sp.Id == 1).Single(),  new DateTime(2019, 10, 15)  ,  new DateTime(2019, 10, 15)    ));
            listContract.Add(new Contract(OrderStatus.Pending, 0.3, 200,  5, new DateTime(2019, 1, 1)   , 0.1, context.Customers.Where(c => c.Id == 3).Single(), context.Services.Where(s => s.Id == 3).Single(), context.RetailStores.Where(a => a.Id == 3).Single(), context.ServicePackages.Where(sp => sp.Id == 1).Single(),  new DateTime(2019, 1, 1)    ,  new DateTime(2019, 1, 1)      ));
            listContract.Add(new Contract(OrderStatus.Pending, 0.3, 100,  5, new DateTime(2018, 1, 1)   , 0.1, context.Customers.Where(c => c.Id == 3).Single(), context.Services.Where(s => s.Id == 3).Single(), context.RetailStores.Where(a => a.Id == 3).Single(), context.ServicePackages.Where(sp => sp.Id == 1).Single(),  new DateTime(2018, 1, 1)    , new DateTime(2018, 1, 1)));
            listContract.Add(new Contract(OrderStatus.Pending, 0.3, 200,  5, new DateTime(2020, 1, 3)   , 0.1, context.Customers.Where(c => c.Id == 1).Single(), context.Services.Where(s => s.Id == 1).Single(), context.RetailStores.Where(a => a.Id == 1).Single(), context.ServicePackages.Where(sp=>sp.Id==1).Single(),      new DateTime(2020, 1, 3)    ,  new DateTime(2020, 1, 3)      ));
            listContract.Add(new Contract(OrderStatus.Pending, 0.3, 400,  5, new DateTime(2016, 1, 2)   , 0.1, context.Customers.Where(c => c.Id == 2).Single(), context.Services.Where(s => s.Id == 2).Single(), context.RetailStores.Where(a => a.Id == 2).Single(), context.ServicePackages.Where(sp => sp.Id == 1).Single(),  new DateTime(2020, 1, 2)    ,  new DateTime(2020, 1, 2)      ));
            listContract.Add(new Contract(OrderStatus.Pending, 0.3, 500,  5, new DateTime(2014, 1, 1)   , 0.1, context.Customers.Where(c => c.Id == 3).Single(), context.Services.Where(s => s.Id == 3).Single(), context.RetailStores.Where(a => a.Id == 3).Single(), context.ServicePackages.Where(sp => sp.Id == 1).Single(),  new DateTime(2020, 1, 1)    ,  new DateTime(2020, 1, 1)      ));
            listContract.Add(new Contract(OrderStatus.Pending, 0.3, 900,  5, new DateTime(2015, 12, 15) , 0.1, context.Customers.Where(c => c.Id == 3).Single(), context.Services.Where(s => s.Id == 3).Single(), context.RetailStores.Where(a => a.Id == 3).Single(), context.ServicePackages.Where(sp => sp.Id == 1).Single(),  new DateTime(2019, 12, 15)  ,  new DateTime(2019, 12, 15)    ));
            listContract.Add(new Contract(OrderStatus.Pending, 0.3, 400,  5, new DateTime(2000, 10, 15) , 0.1, context.Customers.Where(c => c.Id == 3).Single(), context.Services.Where(s => s.Id == 3).Single(), context.RetailStores.Where(a => a.Id == 3).Single(), context.ServicePackages.Where(sp => sp.Id == 1).Single(),  new DateTime(2019, 10, 15)  ,  new DateTime(2019, 10, 15)    ));
            listContract.Add(new Contract(OrderStatus.Pending, 0.3, 200,  5, new DateTime(2019, 1, 1)   , 0.1, context.Customers.Where(c => c.Id == 3).Single(), context.Services.Where(s => s.Id == 3).Single(), context.RetailStores.Where(a => a.Id == 3).Single(), context.ServicePackages.Where(sp => sp.Id == 1).Single(),  new DateTime(2019, 1, 1)    ,  new DateTime(2019, 1, 1)      ));
            listContract.Add(new Contract(OrderStatus.Pending, 0.3, 100,  5, new DateTime(2018, 1, 1)   , 0.1, context.Customers.Where(c => c.Id == 3).Single(), context.Services.Where(s => s.Id == 3).Single(), context.RetailStores.Where(a => a.Id == 3).Single(), context.ServicePackages.Where(sp => sp.Id == 1).Single(),  new DateTime(2018, 1, 1)    , new DateTime(2018, 1, 1)));
