...
=======
            listContract.Add(new Contract(OrderStatus.Pending, 0.3, 500,  5, new DateTime(2019, 1, 1), 0.1, context.Customers.Where(c => c.Id == 1).Single(), context.Services.Where(s => s.Id == 1).Single(), context.RetailStores.Where(a => a.Id == 1).Single(), context.ServicePackages.Where(sp=>sp.Id==1).Single()));
            listContract.Add(new Contract(OrderStatus.Pending, 0.3, 500,  5, new DateTime(2019, 1, 1), 0.1, context.Customers.Where(c => c.Id == 2).Single(), context.Services.Where(s => s.Id == 2).Single(), context.RetailStores.Where(a => a.Id == 2).Single(), context.ServicePackages.Where(sp => sp.Id == 1).Single()));
            listContract.Add(new Contract(OrderStatus.Pending, 0.3, 500,  5, new DateTime(2019, 1, 1), 0.1, context.Customers.Where(c => c.Id == 3).Single(), context.Services.Where(s => s.Id == 3).Single(), context.RetailStores.Where(a => a.Id == 3).Single(), context.ServicePackages.Where(sp => sp.Id == 1).Single()));
>>>>>>> Stashed changes
