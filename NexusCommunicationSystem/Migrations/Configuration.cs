...
namespace NexusCommunicationSystem.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<NexusCommunicationSystem.Models.NexusCommunicationSystemContext>
    {
        ...
        protected override void Seed(NexusCommunicationSystem.Models.NexusCommunicationSystemContext context)
        {
            ...
            listService.Add(new Service("Landline Local 75",      "https://res.cloudinary.com/truonghusk17/image/upload/v1582201922/nyffp4guir6zey2ipvoh.jpg", context.ServicePackages.Where(s => s.Id == 1).Single() , "Unlimited 75$ for an year/call charges 55cents per min/Free setup Fee/Online support 247", 500000));
            listService.Add(new Service("Landline Local 35",      "https://res.cloudinary.com/truonghusk17/image/upload/v1582201922/nyffp4guir6zey2ipvoh.jpg", context.ServicePackages.Where(s => s.Id == 1).Single() , "Monthly 125$/Local 70cents, STD 2.25$ per min/Free setup Fee/Online support 247", 500000));
            listService.Add(new Service("Landline STD 125",       "https://res.cloudinary.com/truonghusk17/image/upload/v1582201922/nyffp4guir6zey2ipvoh.jpg", context.ServicePackages.Where(s => s.Id == 1).Single() , "Monthly 125$/Local 70cents, STD 2.25$ per min/Free setup Fee/Online support 247", 500000));
            listService.Add(new Service("Landline STD 420",       "https://res.cloudinary.com/truonghusk17/image/upload/v1582201922/nyffp4guir6zey2ipvoh.jpg", context.ServicePackages.Where(s => s.Id == 1).Single() , "Half yearly 420$/Local 60cents, STD 2.00$ per min/Free setup Fee/Online support 247", 500000));
            listService.Add(new Service("Landline STD Yearly",    "https://res.cloudinary.com/truonghusk17/image/upload/v1582201922/nyffp4guir6zey2ipvoh.jpg", context.ServicePackages.Where(s => s.Id == 1).Single() , "Yearly 840$/Validity/Free setup Fee/Online support 247", 500000));

            //Internet Service Group: Dial-up                                                                       
            listService.Add(new Service("Dialup Hourly",          "https://res.cloudinary.com/truonghusk17/image/upload/v1582201922/nyffp4guir6zey2ipvoh.jpg", context.ServicePackages.Where(s => s.Id == 1).Single() , "Pay per hour used/Free setup Fee/Free Modem or Router/Online support 247", 500000));
            listService.Add(new Service("Dialup Unlimited 28",    "https://res.cloudinary.com/truonghusk17/image/upload/v1582201922/nyffp4guir6zey2ipvoh.jpg", context.ServicePackages.Where(s => s.Id == 1).Single() , "Unlimited 28Kbps/Free setup Fee/Free Modem or Router/Online support 247", 500000));
            listService.Add(new Service("Dialup Unlimited 56",    "https://res.cloudinary.com/truonghusk17/image/upload/v1582201922/nyffp4guir6zey2ipvoh.jpg", context.ServicePackages.Where(s => s.Id == 1).Single() , "Unlimited 56Kbps/Free setup Fee/Free Modem or Router/Online support 247", 500000));

            //Internet Service Group: Broadband                                                                       
            listService.Add(new Service("Broadband Hourly",       "https://res.cloudinary.com/truonghusk17/image/upload/v1582201922/nyffp4guir6zey2ipvoh.jpg", context.ServicePackages.Where(s => s.Id == 1).Single() , "Pay per hour used/Validity is for 1 or 6 month/Free setup Fee/Free Modem or Router/Online support 247", 500000));
            listService.Add(new Service("Broadband Unlimited 64", "https://res.cloudinary.com/truonghusk17/image/upload/v1582201922/nyffp4guir6zey2ipvoh.jpg", context.ServicePackages.Where(s => s.Id == 1).Single() , "Unlimited 64Kbps/Free setup Fee/Free Modem or Router/Online support 247", 500000));
            listService.Add(new Service("Broadband Unlimited 128", "https://res.cloudinary.com/truonghusk17/image/upload/v1582201922/nyffp4guir6zey2ipvoh.jpg",  context.ServicePackages.Where(s => s.Id == 1).Single(), "Unlimited 128Kbps/Free setup Fee/Free Modem or Router/Online support 247", 500000));
